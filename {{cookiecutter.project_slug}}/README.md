...
This project was generated using https://github.com/encount/full-stack-fastapi-postgresql with:
...
That would be useful if, for example, the project generator (`encount/full-stack-fastapi-postgresql`) was updated and you wanted to integrate or review the changes.
...
```console
$ cookiecutter --config-file ./cookiecutter-config-file.yml --output-dir ../project-copy https://github.com/encount/full-stack-fastapi-postgresql
```
